import { KC } from './js/store/state.js';
import { uploadToCloudinary, getOptimizedUrl } from './js/utils/cloudinaryUtils.js';
...
// Global Secret Keyword Listener (Easter Egg style) - REMOVED for security
...
// Toast system is now imported from components

// ---- Confetti (canvas-based, defined once below) ----
...
function initTabs(container) {
    ...
    // Support both .tabs (generic) and .tab-bar (product detail page)
...
// Note: renderRelatedProducts for product detail page is handled in product-detail.html

// Global variable for current product detail
let currentProductDetail = null;

// ---- Range Slider UI update ----
...
// ---- Firebase Helpers (lazy-loaded, ES module) ----
// Usage: await KCFirebase.saveOrder(orderData)
// ---- UI Rendering Helpers ----
// Video gallery rendering removed from public UI
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Render products on home page if elements exist
    ...
    // Render videos on video display page
